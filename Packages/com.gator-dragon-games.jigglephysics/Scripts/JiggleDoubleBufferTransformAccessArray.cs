...
public class JiggleDoubleBufferTransformAccessArray {
    ...
    public void GenerateNewAccessArrays(ref int currentIndex, out bool hasFinished, List<Transform> transformAccessList, List<Transform> transformRootAccessList, int maxAddCount = 512) {
        if (shouldClear) {
